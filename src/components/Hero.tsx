  ...
  return (
    <section role="region" aria-label="Hero" id="hero" className="relative h-[calc(100vh-4rem)] snap-start snap-always flex items-center justify-center px-6 md:px-12 overflow-hidden banner">
      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          As a recent Computer Engineering graduate of HKUST, I am a passionate and dedicated software engineer with a strong foundation in computer science and a deep love for technology.
        </motion.p>
